...
namespace ORB_SLAM2
{
     ...
     * @param pMP MapPoint
     * @param idx MapPoint在KeyFrame中的索引，与特征点的索引对应
     */
     ...
     * @brief 更新图的连接
     *
     * 1. 首先获得该关键帧的所有MapPoint点，统计观测到这些3d点的每个关键点与其它所有关键帧之间的共视程度
