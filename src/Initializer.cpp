...
namespace ORB_SLAM2
{
     ...
     *
     * @param R21 待计算，初始帧到当前帧的旋转矩阵
     * @param t21 待计算，初始帧到当前帧的平移向量
     * @param vP3D 恢复的3D点，长度为初始帧特征点个数
     * @param vbTriangulated 指示哪些3D点是有效的
     * @return 初始化是否成功，成功，特征点匹配成功，计算位姿成功，计算3D点成功
     */
                                 ...
                                 vector<cv::Point3f> &vP3D, vector<bool> &vbTriangulated)
    {
        ...
        // 不放回的筛选点集，点集总量为mMaxIterations，每个集合有8个点，存储的是关键点的索引号
        // 为什么不从grid里选呢？
