...
namespace ORB_SLAM2
{
    ...
    public:
        ...
        enum eTrackingState
        {
            SYSTEM_NOT_READY = -1, // 系统还没有准备好，需要等一下
            NO_IMAGES_YET = 0,     // 目前还没有图像过来，做其他的事情
            NOT_INITIALIZED = 1,   // 初始化没做，要不去做了，要不后面的事干不了
            OK = 2,                // 所有的准备工作做完了，开始放大招
            LOST = 3               // 跪了，特征丢了，没法正常工作了，赶紧想办法
        };
    ...
    protected:
        ...
        // 单目初始器
        Initializer *mpInitializer; // 单目的初始化类，仅用于单目方案
        ...
        int mMinFrames; // 抽取关键帧的规则，根据帧率，怎么用？
        int mMaxFrames;
